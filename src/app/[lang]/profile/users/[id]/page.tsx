...
export default async function EditUser({params: { lang }}: {params: { lang: Locale }}) {
    const { profilePage, updateUser } = await getDictionary(lang);
        ...
        >
            ...
            >
                ...
                <ProfileLayout lang={lang} text={profilePage}>
                      <EditUserPage lang={lang} text={updateUser}/>
                </ProfileLayout>
            </div>
        </section>
    )
